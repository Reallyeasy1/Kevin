...
| Agent (buyer) wallet, second (GemWallet account; seed moved into .env after the RLUSD faucet claim; used from tx #7 on) | `rn3rtH4jTE52QBWmpV94KEQ1xjcYkJeM8v` | https://testnet.xrpl.org/accounts/rn3rtH4jTE52QBWmpV94KEQ1xjcYkJeM8v |
...
All three curated demo offers (Fast Text, Fast Code, Deep Reasoning) are served by one seller process and settle to the one seller wallet above; the buyer side never holds an account or API key with it. Every RLUSD payment in the buyer wallets' histories is listed below.
...
| 6 | 2026-09-05 05:07:22 | Real inference smoke run (`pnpm smoke:testnet`, seller upstream gpt-4o-mini, summarization prompt -> Fast Text); AT-005 re-executed, same hash | `a4363a13-cb93-4bb0-bee6-567a1c45230d` | `CAA6FEFE4909C36FB9252A3813276117FF3BAEAB21C43893C89F1BAE58CF1174` | `73DB7D20968D45F35D534EB6FDA86692DFCFA889F0F98AEA5EC767AEA98E94AB` | 20496820 | 0.002000 | RLUSD | `tesSUCCESS` | https://testnet.xrpl.org/transactions/73DB7D20968D45F35D534EB6FDA86692DFCFA889F0F98AEA5EC767AEA98E94AB |
| 7 | 2026-09-05 07:19:32 | UI screenshot re-run from the second buyer wallet; seller was still on the mock upstream, superseded by #8 | `9a01d61f-c903-4d28-87d9-525ce35bffe4` | `0B6AE7D2650694ACE7AD8639F25BA22E25E739AA721F84EE35251B1FE75744A6` | `C19EE5AD047876B6C4030B3071808C53E9B04B8B976CAE66530CE1991105507C` | 20499321 | 0.006000 | RLUSD | `tesSUCCESS` | https://testnet.xrpl.org/transactions/C19EE5AD047876B6C4030B3071808C53E9B04B8B976CAE66530CE1991105507C |
| 8 | 2026-09-05 07:22:41 | UI demo run with REAL inference (gpt-4o-mini via seller upstream): screenshots 01-07; AT-005 re-executed twice, same hash | `19b212e6-f5e2-4c3e-a5c8-0f3190ea1c66` | `E44B9CF6772B08CBE19178016E49E74FBC6BEF763E853C6C61E1856BB6291668` | `3450FCC07D9CC530B8DE5D6DC14F124CE3DD6D620CA88229CF262EC0313424ED` | 20499378 | 0.006000 | RLUSD | `tesSUCCESS` | https://testnet.xrpl.org/transactions/3450FCC07D9CC530B8DE5D6DC14F124CE3DD6D620CA88229CF262EC0313424ED |
...
| --- | --- | --- |
| Setup: Testnet badge, wallet balance, modes, max cost | `docs/screenshots/01-setup.png` | Agent wallet `rn3rtH4jTE52QBWmpV94KEQ1xjcYkJeM8v` (second buyer wallet), "XRPL Testnet" badge, balances 8.994000 RLUSD / 19.999964 XRP before the run, the four modes with Balanced selected, max cost 0.020000 RLUSD, idle six-step timeline. |
...
| Result + economic receipt with tx hash | `docs/screenshots/05-receipt.png` | XRPL payment card "Validated", 0.006000 RLUSD to Fast Code, tx `3450FCC0…3424ED`, ledger 20499378, explorer link; the real gpt-4o-mini answer (865 output tokens, 8651 ms provider latency, "classified by LLM" via DeepSeek); the expanded receipt with route id, prompt hash, task, policy checks (all ok), payment SETTLED, full tx hash and explorer URL. No fee or commission row (AT-010). Raw JSON: `docs/screenshots/05-receipt.json`. |
| Explorer page for tx #8 | `docs/screenshots/06-explorer.png` | testnet.xrpl.org: Payment, Success, hash `3450FCC07D9C…`, 0.006 RLUSD (issuer `rQhWct2fv4Vc4KRjRgMrxa8xPN9Zx9iLKV`) from the agent wallet to `r9jnMEauwP4Mh3dfAHNdSjFM4yiYGmsoUD`, ledger 20499378, 2026-09-05 05:02:02 UTC. |
| Duplicate execute: same hash, no new payment | `docs/screenshots/07-duplicate.png` | After two further `POST /v1/routes/19b212e6…/execute` calls (both 202, state SUCCEEDED), the route reloaded via `/?route=<id>`: payment still Validated, same tx `3450FCC0…3424ED`, same ledger 20499378; the ledger holds one Payment for this InvoiceID (AT-005). |
